...
const LANDING_T = {
  nl: {
    ...
    step1_t:"Upload je bestand", step1_d:"Upload één 3MF-project. AutoSlice herkent automatisch het bronformaat.",
    step2_t:"AutoSlice analyseert", step2_d:"Printbaarheid, geometrie, supports, oriëntatie, plaatsing en compatibiliteit worden samen beoordeeld.",
    step3_t:"Kies en download", step3_d:"Kies je doelslicer en printer, valideer het resultaat en download je AutoSlice 3MF.",
    ...
    multi_sub:"Kleur-, materiaal- en toolinformatie wordt behouden of vertaald wanneer bron en doel dit ondersteunen.",
    ...
    dl_h2:"Klaar om te starten?", dl_sub:"Download AutoSlice voor Windows en maak elk ondersteund 3MF-project klaar voor de slicer die jij kiest.",
    ...
    foot_brand:"Eén intelligente workflow van elk ondersteund 3MF-project naar de slicer die jij kiest.",
    ...
    blog1_cat:"Tutorial", blog1_title:"Van elk 3MF-project naar jouw slicer: zo werkt AutoSlice", blog1_date:"15 april 2026",
    blog1_excerpt:"Leer hoe AutoSlice een ondersteund 3MF-project detecteert, analyseert, vertaalt en valideert voor jouw gekozen doel.",
  ...
  en: {
    ...
    step1_t:"Upload your file", step1_d:"Upload one 3MF project. AutoSlice automatically recognizes its source format.",
    step2_t:"AutoSlice analyzes", step2_d:"Printability, geometry, supports, orientation, placement and compatibility are assessed together.",
    step3_t:"Choose and download", step3_d:"Choose your target slicer and printer, validate the result and download your AutoSlice 3MF.",
    ...
    multi_sub:"Color, material and tool information is preserved or translated whenever the source and target support it.",
    ...
    dl_h2:"Ready to get started?", dl_sub:"Download AutoSlice for Windows and prepare supported 3MF projects for the slicer you choose.",
    ...
    foot_brand:"One intelligent workflow from any supported 3MF project to the slicer you choose.",
    ...
    blog1_cat:"Tutorial", blog1_title:"From any 3MF project to your slicer: how AutoSlice works", blog1_date:"April 15, 2026",
    blog1_excerpt:"Learn how AutoSlice detects, analyzes, translates and validates a supported 3MF project for your chosen target.",
  ...
  fr: {
    ...
    step1_t:"Téléversez votre fichier", step1_d:"Téléversez un projet 3MF. AutoSlice reconnaît automatiquement son format source.",
    step2_t:"AutoSlice analyse", step2_d:"Imprimabilité, géométrie, supports, orientation, placement et compatibilité sont évalués ensemble.",
    step3_t:"Choisissez et téléchargez", step3_d:"Choisissez votre slicer et votre imprimante cibles, validez le résultat et téléchargez votre 3MF AutoSlice.",
    ...
    multi_sub:"Les informations de couleur, de matériau et d’outil sont préservées ou traduites lorsque la source et la cible le permettent.",
    ...
    dl_h2:"Prêt à commencer ?", dl_sub:"Téléchargez AutoSlice pour Windows et préparez vos projets 3MF pris en charge pour le slicer de votre choix.",
    ...
    foot_brand:"Un workflow intelligent de tout projet 3MF pris en charge vers le slicer de votre choix.",
    ...
    blog1_cat:"Tutoriel", blog1_title:"De tout projet 3MF à votre slicer : le fonctionnement d’AutoSlice", blog1_date:"15 avril 2026",
    blog1_excerpt:"Découvrez comment AutoSlice détecte, analyse, traduit et valide un projet 3MF pris en charge pour la cible choisie.",
  ...
  de: {
    ...
    step1_t:"Datei hochladen", step1_d:"Laden Sie ein 3MF-Projekt hoch. AutoSlice erkennt das Quellformat automatisch.",
    step2_t:"AutoSlice analysiert", step2_d:"Druckbarkeit, Geometrie, Supports, Ausrichtung, Platzierung und Kompatibilität werden gemeinsam bewertet.",
    step3_t:"Auswählen und laden", step3_d:"Wählen Sie Ziel-Slicer und Drucker, validieren Sie das Ergebnis und laden Sie Ihr AutoSlice 3MF herunter.",
    ...
    multi_sub:"Farb-, Material- und Werkzeugdaten werden erhalten oder übersetzt, wenn Quelle und Ziel dies unterstützen.",
    ...
    dl_h2:"Bereit loszulegen?", dl_sub:"Laden Sie AutoSlice für Windows herunter und bereiten Sie unterstützte 3MF-Projekte für den Slicer Ihrer Wahl vor.",
    ...
    foot_brand:"Ein intelligenter Workflow von jedem unterstützten 3MF-Projekt zum Slicer Ihrer Wahl.",
    ...
    blog1_cat:"Tutorial", blog1_title:"Von jedem 3MF-Projekt zu Ihrem Slicer: So funktioniert AutoSlice", blog1_date:"15. April 2026",
    blog1_excerpt:"Erfahren Sie, wie AutoSlice ein unterstütztes 3MF-Projekt für Ihr gewähltes Ziel erkennt, analysiert, übersetzt und validiert.",
  ...
  es: {
    ...
    step1_t:"Sube tu archivo", step1_d:"Sube un proyecto 3MF. AutoSlice reconoce automáticamente su formato de origen.",
    step2_t:"AutoSlice analiza", step2_d:"Imprimibilidad, geometría, soportes, orientación, colocación y compatibilidad se evalúan en conjunto.",
    step3_t:"Elige y descarga", step3_d:"Elige tu slicer e impresora de destino, valida el resultado y descarga tu 3MF AutoSlice.",
    ...
    multi_sub:"La información de color, material y herramienta se conserva o traduce cuando el origen y el destino lo permiten.",
    ...
    dl_h2:"¿Listo para empezar?", dl_sub:"Descarga AutoSlice para Windows y prepara proyectos 3MF compatibles para el slicer que elijas.",
    ...
    foot_brand:"Un flujo inteligente desde cualquier proyecto 3MF compatible hasta el slicer que elijas.",
    ...
    blog1_cat:"Tutorial", blog1_title:"De cualquier proyecto 3MF a tu slicer: así funciona AutoSlice", blog1_date:"15 de abril de 2026",
    blog1_excerpt:"Descubre cómo AutoSlice detecta, analiza, traduce y valida un proyecto 3MF compatible para el destino elegido.",
  ...
  ko: {
    ...
    step1_t:"파일 업로드", step1_d:"3MF 프로젝트 하나를 업로드하면 AutoSlice가 원본 형식을 자동으로 인식합니다.",
    step2_t:"AutoSlice 분석", step2_d:"출력 가능성, 형상, 서포트, 방향, 배치 및 호환성을 함께 평가합니다.",
    step3_t:"선택 및 다운로드", step3_d:"대상 슬라이서와 프린터를 선택하고 결과를 검증한 뒤 AutoSlice 3MF를 다운로드하세요.",
    ...
    multi_sub:"원본과 대상이 지원하는 경우 색상, 재료 및 도구 정보가 보존되거나 변환됩니다.",
    ...
    dl_h2:"시작할 준비가 되셨나요?", dl_sub:"Windows용 AutoSlice를 다운로드하고 지원되는 3MF 프로젝트를 원하는 슬라이서에 맞게 준비하세요.",
    dl_btn:"Windows용 다운로드", dl_login_lnk:"이미 계정이 있으신가요? 로그인",
    dl_specs:"Windows 10/11 · 64-bit · ~180 MB · 자동 업데이트 포함", dl_soon:"Linux & iOS — 곧 출시",
    foot_brand:"지원되는 모든 3MF 프로젝트에서 원하는 슬라이서까지 이어지는 하나의 지능형 워크플로.",
    ...
    blog1_cat:"튜토리얼", blog1_title:"모든 3MF 프로젝트에서 원하는 슬라이서까지: AutoSlice 사용법", blog1_date:"2026년 4월 15일",
    blog1_excerpt:"AutoSlice가 지원되는 3MF 프로젝트를 감지, 분석, 변환 및 검증하는 방법을 알아보세요.",
...
const INITIAL_REVIEWS: Review[] = [
  ...
  },
  {
    ...
    name: "Sarah M.",
    rating: 4,
    text: "Eén duidelijke workflow voor mijn verschillende 3MF-projecten. AutoSlice houdt de keuzes begrijpelijk en consistent.",
    date: "11 april 2026",
  },
  {
    id: "3",
      ...
      <div className="flex h-[380px]" style={{ background: BG }}>
        ...
        <div className="flex-1 flex flex-col p-4 overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
          <div className="text-sm font-bold text-white">AutoSlice</div>
          <div className="text-[10px] mt-0.5" style={{ color: "rgba(255,255,255,0.3)" }}>ONE FILE. ANY SLICE.</div>
            </div>
            {/* Step pills */}
            <div className="flex items-center gap-1.5">
              {["Upload","Analyse","Download"].map((s,i) => (
...
function TrustBar() {
  const lt = useLT();
  const brands = ["Bambu Studio","OrcaSlicer","PrusaSlicer","Cura","Anycubic","Core 3MF"];
  return (
...
const FEATURES = [
  {
    ...
    title: "Universele 3MF workflow",
    desc: "Upload een 3MF uit een ondersteunde slicer en laat AutoSlice compatibele output voorbereiden.",
    accent: BRAND,
  },
  {
...
// ── How it works ──────────────────────────────────────────────────────────────
const STEPS = [
  { n: "01", title: "Upload je bestand", desc: "Upload één ondersteund 3MF-project; AutoSlice herkent het bronformaat." },
  ...
  { n: "03", title: "Kies en download", desc: "Kies je doel, valideer het resultaat en download je AutoSlice 3MF." },
];
