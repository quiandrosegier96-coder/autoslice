...
def settings_from_project(data: dict[str, object]) -> PrintSettings:
    ...
    return PrintSettings(
        ...
        first_layer_height_mm=_float(_value(data, "first_layer_height", "initial_layer_print_height")),
        wall_count=_int(_value(data, "perimeters", "wall_loops")), top_layers=_int(_value(data, "top_solid_layers", "top_shell_layers")),
        bottom_layers=_int(_value(data, "bottom_solid_layers", "bottom_shell_layers")),
        infill_density_percent=_float(_value(data, "fill_density", "sparse_infill_density")),
        infill_pattern=_str(_value(data, "fill_pattern", "sparse_infill_pattern")),
        print_speed_mm_s=_float(_value(data, "perimeter_speed", "outer_wall_speed")), travel_speed_mm_s=_float(data.get("travel_speed")),
        first_layer_speed_mm_s=_float(_value(data, "first_layer_speed", "initial_layer_speed")),
        nozzle_temperature_c=_int(_value(data, "temperature", "nozzle_temperature")), bed_temperature_c=_int(data.get("bed_temperature")),
        fan_speed_percent=_int(_value(data, "max_fan_speed", "fan_max_speed")),
        ...
        retraction=RetractionSettings(_float(_value(data, "retract_length", "retraction_length")), _float(_value(data, "retract_speed", "retraction_speed")), _float(_value(data, "retract_lift", "z_hop"))),
        ...
        seam_position=_str(data.get("seam_position")), acceleration_mm_s2=_float(data.get("default_acceleration")),
